        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="lg:w-1/2 space-y-8 animate-in fade-in slide-in-from-left-8 duration-1000">
            ...
            <div className="bg-card border-l-[6px] border-primary p-6 rounded-r-xl shadow-2xl shadow-black/20 max-w-xl">
              <p className="text-foreground font-bold text-xl leading-snug italic">
          ...
          <div className="lg:w-1/2 relative group animate-in fade-in slide-in-from-right-8 duration-1000">
            <div className="relative rounded-2xl overflow-hidden shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)] border-4 border-primary/20 bg-card">
              ...
              <div className="absolute bottom-6 left-6 bg-background/90 text-white p-4 rounded-xl border border-primary/30 shadow-2xl backdrop-blur-md">
                <span className="block text-[9px] font-black uppercase tracking-[0.3em] text-primary mb-1.5">EXEMPLO REAL</span>
