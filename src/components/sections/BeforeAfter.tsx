...
export function BeforeAfter() {
  return (
    <section className="bg-background py-12 md:py-16 border-t border-border overflow-hidden">
      <div className="container mx-auto px-6">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-0 items-stretch">
            ...
            {/* Coluna ANTES */}
            <div className="bg-[#1a1a1a] border border-border md:border-r-0 p-6 md:p-8 rounded-t-lg md:rounded-l-lg md:rounded-tr-none flex flex-col">
              <div className="mb-6">
              ...
              <h3 className="text-lg font-bold mb-4 text-muted-foreground uppercase tracking-widest">O Caos da Improvisação</h3>
              ...
              <ul className="space-y-3 flex-grow">
                {[
                  ...
                  <li key={i} className="flex items-start gap-3 text-muted-foreground/70 text-xs">
                    <X className="text-accent flex-shrink-0 mt-0.5" size={16} />
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
            ...
            <div className="hidden md:flex absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 bg-background border-2 border-primary w-12 h-12 rounded-full items-center justify-center shadow-[0_0_20px_rgba(212,168,75,0.3)]">
              <ArrowRight className="text-primary" size={24} />
            </div>

            {/* Seta Central - Mobile */}
            <div className="md:hidden flex justify-center -my-4 relative z-20">
              <div className="bg-background border-2 border-primary w-10 h-10 rounded-full flex items-center justify-center shadow-xl">
                <ArrowDown className="text-primary" size={20} />
              </div>
            </div>

            {/* Coluna DEPOIS */}
            <div className="bg-[#0d1f10] border-2 border-primary p-6 md:p-8 rounded-b-lg md:rounded-r-lg md:rounded-bl-none flex flex-col shadow-2xl shadow-primary/10">
              <div className="mb-6">
              ...
              <h3 className="text-lg font-bold mb-4 gold-gradient-text uppercase tracking-widest">Sítio Próspero e Organizado</h3>
              ...
              <ul className="space-y-3 flex-grow">
                {[
                  ...
                  <li key={i} className="flex items-start gap-3 text-foreground text-xs">
